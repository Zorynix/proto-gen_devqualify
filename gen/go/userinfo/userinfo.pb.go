...
func (x *SendFeedbackRequest) Reset() {
	*x = SendFeedbackRequest{}
	mi := &file_userinfo_userinfo_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendFeedbackRequest) Descriptor() ([]byte, []int) {
	return file_userinfo_userinfo_proto_rawDescGZIP(), []int{27}
}

func (x *SendFeedbackRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *SendFeedbackRequest) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *SendFeedbackRequest) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *SendFeedbackResponse) Reset() {
	*x = SendFeedbackResponse{}
	mi := &file_userinfo_userinfo_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SendFeedbackResponse) Descriptor() ([]byte, []int) {
	return file_userinfo_userinfo_proto_rawDescGZIP(), []int{28}
}
...
func (x *SendFeedbackResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_userinfo_userinfo_proto_rawDesc = "" +
	...
	"\x14SendFeedbackResponse\x12\x18\n" +
	...
	"\rGetUserAvatar\x12!.userinfo.v1.GetUserAvatarRequest\x1a\".userinfo.v1.GetUserAvatarResponse\x12S\n" +
	"\fSendFeedback\x12 .userinfo.v1.SendFeedbackRequest\x1a!.userinfo.v1.SendFeedbackResponseB Z\x1ediploma.userinfo.v1;userinfov1b\x06proto3"
...
var file_userinfo_userinfo_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_userinfo_userinfo_proto_goTypes = []any{
	...
	(*SendFeedbackRequest)(nil),                      // 29: userinfo.v1.SendFeedbackRequest
	(*SendFeedbackResponse)(nil),                     // 30: userinfo.v1.SendFeedbackResponse
}
var file_userinfo_userinfo_proto_depIdxs = []int32{
	...
	29, // 27: userinfo.v1.UserService.SendFeedback:input_type -> userinfo.v1.SendFeedbackRequest
	10, // 28: userinfo.v1.UserService.GetUser:output_type -> userinfo.v1.GetUserResponse
	12, // 29: userinfo.v1.UserService.UpdateUserProfile:output_type -> userinfo.v1.UpdateUserProfileResponse
	14, // 30: userinfo.v1.UserService.GetUserTestHistory:output_type -> userinfo.v1.GetUserTestHistoryResponse
	16, // 31: userinfo.v1.UserService.GetUserAchievements:output_type -> userinfo.v1.GetUserAchievementsResponse
	18, // 32: userinfo.v1.UserService.GetLeaderboard:output_type -> userinfo.v1.GetLeaderboardResponse
	20, // 33: userinfo.v1.UserService.UpdateUserAchievements:output_type -> userinfo.v1.UpdateUserAchievementsResponse
	28, // 34: userinfo.v1.UserService.CheckUserAchievements:output_type -> userinfo.v1.CheckUserAchievementsResponse
	22, // 35: userinfo.v1.UserService.UploadUserAvatar:output_type -> userinfo.v1.UploadUserAvatarResponse
	24, // 36: userinfo.v1.UserService.UpdateUserAvatar:output_type -> userinfo.v1.UpdateUserAvatarResponse
	26, // 37: userinfo.v1.UserService.GetUserAvatar:output_type -> userinfo.v1.GetUserAvatarResponse
	30, // 38: userinfo.v1.UserService.SendFeedback:output_type -> userinfo.v1.SendFeedbackResponse
